...
base_states = 10
extra_states = 2
state_count = base_states + extra_states
...
def add_controller(
    ...
    __generate_initial_population(
        initial_pop_file, possible_decisions, combinations, global_evolvables
    )
        ...
        for combination in combinations:
            ...
            for counter_id in counter_ids:
                if uncertainty_aware:
                    print("I am uncertainty aware!")
                    if state_counter > base_states:
...
def __generate_initial_population(
    file_path, possible_decisions, combinations, global_evolvables
):
